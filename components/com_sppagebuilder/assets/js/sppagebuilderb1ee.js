      ...
      e && e.preventDefault(),
        ...
        e.isDefaultPrevented() ||
          ...
          t.support.transition && s.hasClass("sppb-fade")
            ? s.one("bsTransitionEnd", a).emulateTransitionEnd(150)
            : a());
    });
  var n = t.fn.spbalert;
  ...
  (function (t) {
    ...
    (t.event.special.inview = {
      ...
      t(document).on("inview", ".sppb-animated-number", function (e, i, n, s) {
        var a = t(this);
        i &&
          (a.sppbanimateNumbers(a.data("digit"), !1, a.data("duration")),
          a.unbind("inview"));
      }),
        ...
        new MutationObserver(function (t) {
          t.forEach(function (t) {
            ...
            null !== e &&
              jQuery(e).each(function () {
                jQuery(this)
                  .find(".sppb-articles-carousel-wrap")
                  .each(function () {
                    var t = jQuery(this).data("articles"),
  ...
  window.addEventListener("DOMContentLoaded", function () {
    ...
    function i(t, i) {
      t.forEach(function (t) {
        ...
        t.intersectionRatio &&
          (("IMG" !== n.tagName && "IFRAME" !== n.tagName) ||
            (n.src = n.dataset.large),
          n.classList.contains("sppb-element-lazy") &&
            n.classList.add("sppb-element-loaded"),
          "VIDEO" === n.tagName && e(n),
          null !== s && e(s),
          a && (a.src = a.dataset.src),
          i.unobserve(n));
      });
    }
    if (t.length > 0) {

    ...
    t(document).ready(function () {
      t(".sppb-carousel-extended").each(function () {
        ...
        ("layout3" !== e && "layout4" !== e) || (p = !0),
          "layout3" === e && ((s = 1), (n = 1), (a = 1)),
          p &&
            ((l = i.data("padding")),
            (c = i.data("padding-sm")),
            (m = i.data("padding-xs"))),
          "layout1" === e &&
            ((s = 1), (n = 1), (a = 1), (l = 0), (d = 0), u && (v = "fadeIn"));
        var f = i.data("height"),
          g = i.data("height-sm"),
          x = i.data("height-xs"),
        ...
        i.spCarousel({
          ...
          nav_text: [
            ...
            '<i class="fa ' + I + '" aria-hidden="true"></i>',
          ],
          animationType: v,
          responsive: [
            { viewport: 1170, height: f, items: s },
            { viewport: 767, height: g, items: n, centerPadding: c },
            { viewport: 320, height: x, items: a, centerPadding: m },
          ],
        });
      });
              ...
              t(this)
                ...
                .each(function () {
                  ...
                  i.spCarousel({
                    ...
                    responsive: [
                      { viewport: 1170, height: f, items: s },
                      { viewport: 767, height: g, items: n, centerPadding: u },
                      { viewport: 320, height: x, items: a, centerPadding: v },
                    ],
                  });
                });
            });

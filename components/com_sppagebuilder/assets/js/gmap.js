  ...
  jQuery(".sppb-addon-gmap-canvas", t).each(function (a) {
    var r = jQuery(this).attr("id"),
      ...
      c = {
        ...
        lng: Number(jQuery(this).attr("data-lng")),
      },
      u = new google.maps.Map(t.getElementById(r), {
        center: new google.maps.LatLng(c),
        zoom: o,
        scrollwheel: d,
        disableDefaultUI: i,
      });
    if (void 0 !== jQuery(this).attr("data-location")) {
      ...
      for (j = 0; j < _.length; j++)
        (A = new google.maps.Marker({
          position: new google.maps.LatLng(_[j][1], _[j][2]),
          map: u,
        })),
